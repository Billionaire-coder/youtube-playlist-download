...
def download_playlist(playlist_url, cookies_file_path=None):
    ...
    merging video and audio streams if necessary.
    ...
    ydl_opts = {
        # *** MODIFIED FORMAT OPTION to limit resolution to 1440p ***
        # This selects the best video stream with height less than or equal to 1440,
        # combines it with the best audio stream, or falls back to the overall best available.
    ...
    try:
        ...
        if ret_code == 0:
            ...
            print("Please check the output above for specific errors (e.g., 'Playlist does not exist').")


    except Exception as e:
        # This catches general Python errors, though yt-dlp usually handles its own
...
if __name__ == "__main__":
    ...
    if url_to_use:
        # Pass the cookies file path instead of the browser name
