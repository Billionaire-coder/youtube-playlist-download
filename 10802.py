...
def download_playlist(playlist_url, cookies_file_path=None):
    ...
    ydl_opts = {
        # 1. Format and Resolution Limit: Selects best separate video stream <= 1080p + best audio
        ...
        # *** Options added to ensure post-processing (FFmpeg merge) runs correctly ***
        # Forces the writing of metadata/description, which helps ensure post-processors are run.
        'writedescription': True, 
        # Explicitly disables thumbnail downloading to simplify the post-processor chain.
